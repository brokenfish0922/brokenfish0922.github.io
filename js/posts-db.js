const allPosts = [
    ...
    },
    {
        ...
        date: '2025年9月18日',
        tags: ['香川', '高松', '小豆島', '愛媛', '松山', '道後溫泉', '美食', '甜點', '飲料', '啤酒', '麵包', '超市', '蜜柑', '果汁']
    },



    {
        url: '2025shigoku/ryusuitemple.html',
        image: 'image2025/35/01.jpg',
        category: '神社與寺廟',
        title: '西の滝 龍水寺',
        excerpt: '坐落於小豆島懸崖上的天空靈場，俯瞰瀨戶內海的絕景，體驗超過千年的山岳信仰之力。',
        date: '2025年10月02日',
        tags: ['香川', '高松', '小豆島', '景點', '寺廟神社']
    },
    {
        url: '2025shigoku/kotohiragu.html',
        image: 'image2025/36/01.png',
        category: '神社與寺廟',
        title: '金刀比羅宮',
        excerpt: '日本人一生必訪的海上守護神，挑戰1,368級石階的能量聖地。',
        date: '2025年10月02日',
        tags: ['香川', '高松', '景點', '寺廟神社']
    },
    ...
    {
        url: '2025shigoku/yashimajitemple.html',
        image: 'image2025/37/01.jpg',
        category: '神社與寺廟',
        title: '屋島寺',
        excerpt: '這座寺廟不僅是信眾的朝聖地，更是結合了壯麗自然景觀、豐富歷史文物與有趣民間傳說的觀光名勝。',
        date: '2025年10月03日',
        tags: ['香川', '高松', '景點', '寺廟神社']
    },
    ...
    {
        url: '2025shigoku/yashimajinja.html',
        image: 'image2025/38/07.jpg',
        category: '神社與寺廟',
        title: '屋島神社',
        excerpt: '這裡雖然不像山頂的屋島寺那樣廣為人知，但其精緻的建築雕刻、靜謐的氛圍以及與德川家深厚的淵源，使其成為歷史愛好者與尋求寧靜的參拜者心中的秘境。',
        date: '2025年10月03日',
        tags: ['香川', '高松', '景點', '寺廟神社']
    },
    {
        url: '2025shigoku/isaniwajinja.html',
        image: 'image2025/39/02.jpg',
        category: '神社與寺廟',
        title: '伊佐爾波神社',
        excerpt: '這座神社不僅是當地重要的信仰中心，更因其獨特的建築樣式和登高望遠的絕佳視野，成為造訪道後溫泉的遊客幾乎必訪的景點。',
        date: '2025年10月03日',
        tags: ['愛媛', '松山', '道後溫泉', '景點', '寺廟神社']
    },



    {
        url: '2025shigoku/busshozan.html',
        image: 'image2025/40/07.jpg',
        category: '古蹟與老街',
        title: '佛生山',
        excerpt: '在充滿歷史感的街道上漫步，探訪古老的寺廟與商家，轉角又能遇見時尚的咖啡廳、雜貨店與餐廳，這種充滿驚喜的對比感，構成了佛生山獨一無二的旅行體驗。',
        date: '2025年10月03日',
        tags: ['香川', '高松', '景點', '老街', '溫泉']
    },
    {
        url: '2025shigoku/uchiko.html',
        image: 'image2025/41/14.jpg',
        category: '古蹟與老街',
        title: '八日市護國傳統建物保存地區',
        excerpt: '約600公尺長的街道，兩側林立著江戶至明治時代的傳統町屋與豪宅，走在這裡彷彿像是「穿越時空」一般，感覺時間的流動都變慢了。',
        date: '2025年10月05日',
        tags: ['愛媛', '景點', '老街']
    },
    {
        url: '2025shigoku/mitsuhama.html',
        image: 'image2025/42/03.jpg',
        category: '古蹟與老街',
        title: '三津濱老街',
        excerpt: '漫步在錯綜的巷弄間，可見昔日的商家、土藏與洋風建築交錯林立，彷彿穿越了時光隧道。',
        date: '2025年10月05日',
        tags: ['愛媛', '景點', '老街']
    },
    ...
    {
        url: '2025shigoku/heneitongbao.html',
        image: 'image2025/43/01.jpg',
        category: '自然風景與觀光景點',
        title: '錢形砂繪',
        excerpt: '這是一個巨大的「寛永通寶」錢幣砂繪，被譽為強大的能量景點，相傳能為親眼見到的人帶來好運。',
        date: '2025年10月05日',
        tags: ['香川', '景點']
    },
    {
        url: '2025shigoku/kankakei.html',
        image: 'image2025/44/01.jpg',
        category: '自然風景與觀光景點',
        title: '寒霞溪',
        excerpt: '被譽為日本三大最美溪谷之一，隨四季更迭的壯麗景色，是小豆島最具代表性的絕景。',
        date: '2025年10月05日',
        tags: ['香川', '小豆島', '景點']
    },
    {
        url: '2025shigoku/angelroad.html',
        image: 'image2025/45/01.jpg',
        category: '自然風景與觀光景點',
        title: '天使之路',
        excerpt: '每天有兩次退潮的機會可以看見完全顯露的天使之路，可直接走到對面的島嶼上。有一個美麗的傳說：「只要與生命中重要的人攜手走過這條步道，便能實現心中的願望，得到一生的幸福」。',
        date: '2025年10月05日',
        tags: ['香川', '小豆島', '景點']
    },
    {
        url: '2025shigoku/shodoshimaolivepark.html',
        image: 'image2025/46/12.jpg',
        category: '自然風景與觀光景點',
        title: '小豆島橄欖公園',
        excerpt: '真人版魔女宅急便的拍攝地，是粉絲們的朝聖聖地。',
        date: '2025年10月05日',
        tags: ['香川', '小豆島', '景點']
    },
    {
        url: '2025shigoku/yashima.html',
        image: 'image2025/47/01.jpg',
        category: '自然風景與觀光景點',
        title: '屋島',
        excerpt: '這座漂浮於瀨戶內海、狀如屋頂的熔岩台地，不僅是高松市的醒目地標，更是歷史與自然交織的寶庫。',
        date: '2025年10月06日',
        tags: ['香川', '高松', '景點']
    },
    ...
    {
        url: '2025shigoku/dogohaikarastreet.html',
        image: 'image2025/48/11.jpg',
        category: '商店街與購物中心',
        title: '道後溫泉商店街',
        excerpt: '連結道後溫泉本館與車站的「道後溫泉商店街」，是一條充滿明治時代迷人風情的拱廊街道。',
        date: '2025年10月06日',
        tags: ['愛媛', '松山', '景點','道後溫泉', '溫泉', '商店街']
    },
    {
        url: '2025shigoku/takamatsushopping.html',
        image: 'image2025/49/01.jpg',
        category: '商店街與購物中心',
        title: '高松中央商店街',
        excerpt: '在這座不受天氣影響的巨大購物空間裡，集結了從百貨公司、在地美食、百年老舖到流行品牌的各式店家。無論是在地居民還是觀光客，都能在此盡情享受逛街與品嚐美食的樂趣，感受高松市中心的滿滿活力。',
        date: '2025年10月06日',
        tags: ['香川', '高松', '景點', '商店街']
    },
    {
        url: '2025shigoku/jumpstore.html',
        image: 'image2025/50/01.jpg',
        category: '展覽場館',
        title: 'Jump 快閃店',
        excerpt: '我們在愛媛縣松山市最大的購物中心「EMIFULL MASAKI」購物時剛好遇到JUMP快閃商店(只有1週)，熱愛動漫的我們當然是要進去逛一下拍個照啦！',
        date: '2025年10月06日',
        tags: ['愛媛', '景點']
    },
    {
        url: '2025shigoku/towelmuseum.html',
        image: 'image2025/51/06.jpg',
        category: '展覽場館',
        title: '毛巾美術館',
        excerpt: '毛巾美術館全球首座以毛巾為主題的美術館，宗旨是成為「療癒身心靈的珍藏之地」，來到愛媛當然要來這個毛巾美術館參觀一下，裡頭不僅詳細解說毛巾的製造過程，還展示了各種以毛巾為題材的藝術作品。',
        date: '2025年10月06日',
        tags: ['愛媛', '今治', '景點']
    },
    {
        url: '2025shigoku/ehimescience.html',
        image: 'image2025/52/01.jpg',
        category: '展覽場館',
        title: '愛媛縣綜合科學博物館',
        excerpt: '愛媛縣綜合科學博物館是個可以透過體驗來學習科學的大寶庫，館內不僅分為自然、科學技術與產業三大主題展區，更擁有世界最大等級的巨蛋天象儀，讓您彷彿身歷其境般地遨遊於浩瀚星空之中。',
        date: '2025年10月06日',
        tags: ['愛媛', '景點']
    },
    {
        url: '2025shigoku/shikokuaquarium.html',
        image: 'image2025/53/01.jpg',
        category: '展覽場館',
        title: '四國水族館',
        excerpt: '香川縣熱門景點之一，雖然規模不大，但裡面的動物種類非常豐富，利用四國多樣態的自然資源與海洋環境作為展示的基底，讓參觀者可以體驗到四國擁有多麼豐富的動物生態系。',
        date: '2025年10月06日',
        tags: ['香川', '景點']
    },
    {
        url: '2025shigoku/shodoshimaferry2.html',
        image: 'image2025/54/01.jpg',
        category: '無法分類的旅途記憶',
        title: '小豆島渡輪',
        excerpt: '往返高松港與小豆島之間搭乘小豆島渡輪，來回分別搭乘到彩繪了「呆呆獸」以及「擅長捉弄人的高木同學」的彩繪渡輪，為旅途增添了愉快的氣氛。',
        date: '2025年10月06日',
        tags: ['香川', '高松', '小豆島']
    },
    {
        url: '2025shigoku/sanukitakamatsumatsuri.html',
        image: 'image2025/55/10.jpg',
        category: '無法分類的旅途記憶',
        title: '讚岐高松祭',
        excerpt: '每年的8/12~8/14期間會在高松市區舉辦「讚岐高松祭」 這個盛大的祭典，而8/13這天的重頭戲就是花火大會。',
        date: '2025年10月06日',
        tags: ['香川', '高松', '祭典', '花火大會']
    },
    {
        url: '2025shigoku/heiseicar.html',
        image: 'image2025/56/01.jpg',
        category: '無法分類的旅途記憶',
        title: '平成租車',
        excerpt: '這次的四國之旅選擇自駕作為交通移動方式，租車公司為四國當地老牌的「平成租車」，服務態度非常好、租車速度快，推薦來四國遊玩的朋友考慮來這裡租車喔！',
        date: '2025年10月06日',
        tags: ['香川', '高松']
    }
    // ... 在此處加入您所有的文章資訊 ...
